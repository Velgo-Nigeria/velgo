...
const alertsBranch = cond.getWhenFalse();

const identifiers = alertsBranch.getDescendantsOfKind(SyntaxKind.Identifier);
...
alertsBranch.replaceWithText(newJsx);
...
sourceFile.saveSync();
console.log("Successfully extracted AlertsTab");
